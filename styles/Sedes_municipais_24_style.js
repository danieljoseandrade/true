...
var style_Sedes_municipais_24 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = "";
    size = 0;
    var labelFont = "8.125px \'MS Shell Dlg 2\', sans-serif";
    var labelFill = "rgba(0, 0, 0, 1)";
    var textAlign = "left";
    var offsetX = 8;
    var offsetY = 3;
    if (feature.get("q2wHide_Municipio") !== null) {
        labelText = String(feature.get("q2wHide_Municipio"));
    }
...
function update() {
    ...
    var features = lyr_Sedes_municipais_24.getSource().getFeatures();
    features.forEach(function(feature){
        ...
        var text = feature.get("q2wHide_Municipio");
