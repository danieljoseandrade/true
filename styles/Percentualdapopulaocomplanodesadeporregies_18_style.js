...
function categories_Percentualdapopulaocomplanodesadeporregies_18(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '17.96':
...
var style_Percentualdapopulaocomplanodesadeporregies_18 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões10");
    var labelText = "";
    size = 0;
...
var style = categories_Percentualdapopulaocomplanodesadeporregies_18(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_Percentualdapopulaocomplanodesadeporregies_18.getSource().getFeatures();
