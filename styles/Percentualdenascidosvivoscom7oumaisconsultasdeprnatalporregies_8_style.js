...
function categories_Percentualdenascidosvivoscom7oumaisconsultasdeprnatalporregies_8(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '70.81':
...
var style_Percentualdenascidosvivoscom7oumaisconsultasdeprnatalporregies_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_5");
    var labelText = "";
    size = 0;
...
var style = categories_Percentualdenascidosvivoscom7oumaisconsultasdeprnatalporregies_8(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_Percentualdenascidosvivoscom7oumaisconsultasdeprnatalporregies_8.getSource().getFeatures();
