...
function categories_Taxademortalidadepordoenadoaparelhocirculatrioporregies_4(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '126.38':
...
var style_Taxademortalidadepordoenadoaparelhocirculatrioporregies_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_3");
    var labelText = "";
    size = 0;
...
var style = categories_Taxademortalidadepordoenadoaparelhocirculatrioporregies_4(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_Taxademortalidadepordoenadoaparelhocirculatrioporregies_4.getSource().getFeatures();
