...
function categories_PercentualdapopulaocobertaporequipesdeatenobsicaSUSporregies_16(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '86.6':
...
var style_PercentualdapopulaocobertaporequipesdeatenobsicaSUSporregies_16 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_9");
    var labelText = "";
    size = 0;
...
var style = categories_PercentualdapopulaocobertaporequipesdeatenobsicaSUSporregies_16(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_PercentualdapopulaocobertaporequipesdeatenobsicaSUSporregies_16.getSource().getFeatures();
