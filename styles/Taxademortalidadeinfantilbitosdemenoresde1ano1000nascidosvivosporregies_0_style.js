...
function categories_Taxademortalidadeinfantilbitosdemenoresde1ano1000nascidosvivosporregies_0(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '8.94':
...
var style_Taxademortalidadeinfantilbitosdemenoresde1ano1000nascidosvivosporregies_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_1");
    var labelText = "";
    size = 0;
...
var style = categories_Taxademortalidadeinfantilbitosdemenoresde1ano1000nascidosvivosporregies_0(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_Taxademortalidadeinfantilbitosdemenoresde1ano1000nascidosvivosporregies_0.getSource().getFeatures();
