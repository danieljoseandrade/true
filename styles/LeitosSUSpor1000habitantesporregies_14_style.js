...
function categories_LeitosSUSpor1000habitantesporregies_14(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '0.98':
...
var style_LeitosSUSpor1000habitantesporregies_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_8");
    var labelText = "";
    size = 0;
...
var style = categories_LeitosSUSpor1000habitantesporregies_14(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_LeitosSUSpor1000habitantesporregies_14.getSource().getFeatures();
