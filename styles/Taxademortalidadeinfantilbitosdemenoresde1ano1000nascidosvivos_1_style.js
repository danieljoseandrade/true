...
var style_Taxademortalidadeinfantilbitosdemenoresde1ano1000nascidosvivos_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Saude Mu_1");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 6.780000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 6.780000 && value <= 13.560000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 13.560000 && value <= 20.340000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 20.340000 && value <= 27.120000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 27.120000 && value <= 33.900000) {
            style = [ new ol.style.Style({
...
function update() {
    ...
    var features = lyr_Taxademortalidadeinfantilbitosdemenoresde1ano1000nascidosvivos_1.getSource().getFeatures();
