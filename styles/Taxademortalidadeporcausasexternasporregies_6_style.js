...
function categories_Taxademortalidadeporcausasexternasporregies_6(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '52.89':
...
var style_Taxademortalidadeporcausasexternasporregies_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_4");
    var labelText = "";
    size = 0;
...
var style = categories_Taxademortalidadeporcausasexternasporregies_6(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_Taxademortalidadeporcausasexternasporregies_6.getSource().getFeatures();
