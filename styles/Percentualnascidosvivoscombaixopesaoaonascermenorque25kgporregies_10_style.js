...
function categories_Percentualnascidosvivoscombaixopesaoaonascermenorque25kgporregies_10(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '7.95':
...
var style_Percentualnascidosvivoscombaixopesaoaonascermenorque25kgporregies_10 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_6");
    var labelText = "";
    size = 0;
...
var style = categories_Percentualnascidosvivoscombaixopesaoaonascermenorque25kgporregies_10(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_Percentualnascidosvivoscombaixopesaoaonascermenorque25kgporregies_10.getSource().getFeatures();
