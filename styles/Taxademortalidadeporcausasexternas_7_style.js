...
var style_Taxademortalidadeporcausasexternas_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Saude Mu_4");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 32.264000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 32.264000 && value <= 64.528000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 64.528000 && value <= 96.792000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 96.792000 && value <= 129.056000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 129.056000 && value <= 161.320000) {
            style = [ new ol.style.Style({
...
function update() {
    ...
    var features = lyr_Taxademortalidadeporcausasexternas_7.getSource().getFeatures();
