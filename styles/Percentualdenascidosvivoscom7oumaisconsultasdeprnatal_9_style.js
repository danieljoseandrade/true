...
var style_Percentualdenascidosvivoscom7oumaisconsultasdeprnatal_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Saude Mu_5");
    var labelText = "";
    size = 0;
    ...
    if (value > 48.650000 && value <= 56.962000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 56.962000 && value <= 65.274000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 65.274000 && value <= 73.586000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 73.586000 && value <= 81.898000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 81.898000 && value <= 90.210000) {
            style = [ new ol.style.Style({
...
function update() {
    ...
    var features = lyr_Percentualdenascidosvivoscom7oumaisconsultasdeprnatal_9.getSource().getFeatures();
