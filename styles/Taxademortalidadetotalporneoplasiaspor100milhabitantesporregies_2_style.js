...
function categories_Taxademortalidadetotalporneoplasiaspor100milhabitantesporregies_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case '29.18':
...
var style_Taxademortalidadetotalporneoplasiaspor100milhabitantesporregies_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("REgiões_2");
    var labelText = "";
    size = 0;
...
var style = categories_Taxademortalidadetotalporneoplasiaspor100milhabitantesporregies_2(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
...
function update() {
    ...
    var features = lyr_Taxademortalidadetotalporneoplasiaspor100milhabitantesporregies_2.getSource().getFeatures();
