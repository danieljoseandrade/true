...
var style_Percentualdapopulaocomplanodesade_19 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Saude Mu10");
    var labelText = "";
    size = 0;
    ...
    if (value > 3.960000 && value <= 12.800000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 12.800000 && value <= 21.640000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 21.640000 && value <= 30.480000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 30.480000 && value <= 39.320000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 39.320000 && value <= 48.160000) {
            style = [ new ol.style.Style({
...
function update() {
    ...
    var features = lyr_Percentualdapopulaocomplanodesade_19.getSource().getFeatures();
