...
var style_DespesaemsadepercapitaR_21 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Saude Mu11");
    var labelText = "";
    size = 0;
    ...
    if (value > 329.200000 && value <= 585.062000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 585.062000 && value <= 840.924000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 840.924000 && value <= 1096.786000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1096.786000 && value <= 1352.648000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 1352.648000 && value <= 1608.510000) {
            style = [ new ol.style.Style({
...
function update() {
    ...
    var features = lyr_DespesaemsadepercapitaR_21.getSource().getFeatures();
